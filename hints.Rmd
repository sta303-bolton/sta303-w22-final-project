...
This will be what you consider in the writing of your report. What would a real consultant do for a really client. 

__2) As responsible students/statisticians at U of T. (GitHub/portfolio world)__

This will be what you consider in sharing your report in the 'real world'. To access the postcode data you need to agree to the U of T license around it (make sure you do this, even if you need to use the `break-glass` in the end). This means this file should NOT be shared on your GitHub or as part of any portfolio of your work. 'Keep it secret, keep it safe'.
